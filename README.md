...
### Applications
[PRS for three major psychiartric disorders]: Feng Y, Jia N, Huang P, Hu S\*, <em><strong>Yang S</strong></em>\*. Cross-ancestry genetic architecture reveals shared biological pathways of major psychiatric disorders. <em>Mol Psychiatry</em>. 2026. (In press).  <br>

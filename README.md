...
### Applications
[PRS for three major psychiartric disorders](https://www.nature.com/articles/s41380-026-03541-3): Feng Y, Guo X, Huang P, Jia N, Hu S\*, <em><strong>Yang S</strong></em>\*. Cross-ancestry pleiotropic analysis of imaging-derived phenotypes enhances risk stratification of depression. <em>Mol Psychiatry</em>. (Accepted) <br>
[PRS for three major psychiartric disorders](https://www.nature.com/articles/s41380-026-03541-3): Feng Y, Jia N, Huang P, Hu S\*, <em><strong>Yang S</strong></em>\*. Cross-ancestry genetic architecture reveals shared biological pathways of major psychiatric disorders. <em>Mol Psychiatry</em>. 2026 Mar 17. doi: 10.1038/s41380-026-03541-3.  <br>
[PRS for biopolar disease](https://onlinelibrary.wiley.com/doi/10.1002/mco2.7062): Feng Y, Guo X, Huang P, Ji X, Jia N, <em><strong>Yang S</strong></em>\*, Hu S\*. Cerebrospinal Fluid Genetics Enhance Risk Stratification in Bipolar Disorder. <em>MedComm (2020)</em>. 2026 Feb 26;7(3):e70629. doi: 10.1002/mco2.70629. <br>
